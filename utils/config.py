...
def process_config(json_file):
    ...
    config.summary_dir = os.path.join(config.out_root_dir, config.exp_name, "summaries/")
    config.checkpoint_dir = os.path.join(config.out_root_dir, config.exp_name, "checkpoints/")
    config.out_dir = os.path.join(config.out_root_dir, config.exp_name, "out/")
    config.log_dir = os.path.join(config.out_root_dir, config.exp_name, "logs/")
    config.tensorboard_for_all_exp = os.path.join(config.out_root_dir, "tensorboard_for_all_exp")
    create_dirs([config.summary_dir, config.checkpoint_dir, config.out_dir, config.log_dir, config.tensorboard_for_all_exp])
